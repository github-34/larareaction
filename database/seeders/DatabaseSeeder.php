...
//        $this->call(ReactionSeeder::class);
        ...
        // Reaction is always numeric: if discrete then integer, if non-discrete then float,
        // NOTE: for float (non-discrete) ranges, cannot have names for decimals values (3.56 => 'meh')
        ReactionType::create([ 'id' => 1, 'description' => 'Applause',         'discrete' => true, 'min' => 1, 'max' => 1,
            'icons' => json_encode([ 1 => 'applause.jpg']),
            'names' => json_encode([ 1 => 'applause' ])]);
        ReactionType::create([ 'id' => 2, 'description' => 'Like - Dislike',   'discrete' => true, 'min' => 0, 'max' => 1,
            'icons' => json_encode([ 0 => 'thumbsdown.jpg', 1 => 'thumbsup.jpg']),
            'names' => json_encode([ 0 => 'dislike', 1 => 'like' ])]);
        ReactionType::create([ 'id' => 3, 'description' => 'Hot - Cold',       'discrete' => true, 'min' => 1, 'max' => 2, 'icons' => json_encode([]), 'names' => json_encode([ 1 => 'cold', 2 => 'hot' ])]);
        ReactionType::create([ 'id' => 4, 'description' => 'Hot - Cold',       'discrete' => false,'min' => 1, 'max' => 5, 'icons' => json_encode([]), 'names' => json_encode([ 1 => 'cold', 5 => 'hot'])]);
        ReactionType::create([ 'id' => 5, 'description' => 'Cognitive',        'discrete' => true, 'min' => 1, 'max' => 3, 'icons' => json_encode([]), 'names' => json_encode([ 1 => 'interesting', 2 => 'clear as day', 3 => 'i\'m confused' ])  ]);
        ReactionType::create([ 'id' => 6, 'description' => 'Emotive',          'discrete' => true, 'min' => 1, 'max' => 3, 'icons' => json_encode([]), 'names' => json_encode([ 1 => 'happy', 2 => 'super happy', 3 => 'sad' ])  ]);
        ReactionType::create([ 'id' => 7, 'description' => '5-Star Rating',    'discrete' => true, 'min' => 1, 'max' => 5, 'icons' => json_encode([]), 'names' => null]);
        ReactionType::create([ 'id' => 8, 'description' => 'Michelin Stars',   'discrete' => true, 'min' => 1, 'max' => 3, 'icons' => json_encode([]), 'names' => json_encode([ 1 => '1 Michelin Star', 2=> '2 Michelin Stars', 3 => '3 Michelin Stars' ])]);
        ReactionType::create([ 'id' => 9, 'description' => 'Vote',             'discrete' => true, 'min' => 1, 'max' => 3, 'icons' => json_encode([ 0 => '']), 'names' => json_encode([ 1 => 'in favor', 2 => 'against', 3 => 'abstain' ])]);

        ReactionType::create([ 'id' => 10, 'description' => 'Elo Rating',       'discrete' => true, 'min' => 1, 'max' => 4000, 'names' => json_encode(
            [ 0 => 'Novice',
